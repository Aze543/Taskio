      ...
      <SignedOut>
          ...
          <nav className="navbar d-flex justify-content-between align-items-center">
            ...
            <div className="d-none d-sm-flex">
              <Link to={"/sign-in"}>
                <Button
                  variant="link"
                  className="me-3 my-1 text-dark fw-medium"
                >
                  Sign In
                </Button>
              </Link>
              <Link to={"/sign-up"}>
                <Button variant="" className="btn-gradient">
                  Sign up →
                </Button>
              </Link>
            </div>
        ...
        <section className="hero py-5 mx-2">
          <h1 className="display-2">
            ...
            <br />
            or Solo Work with Taskio
          </h1>
          <p>
            Taskio helps you easily organize your to-dos, focus on what matters,
